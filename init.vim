...
Plug 'unblevable/quick-scope' " left to right highlighting
call plug#end()
...
set spell                         " spelling correction
set tabstop=2 softtabstop=2       " number of columns occupied by a tab character
set shiftwidth=2                  " width for autoindents
set ignorecase                    " case insensitive matching
set hlsearch                      " highlight search results
set noshowmode                    " remove the INSERT line to allow for lightline
set showmatch                     " show matching brackets
set list                          " enable the whitespace character mode
set listchars=tab:>\ ,trail:⋅     " config for the tab, eol and trailing spaces
...
set background=dark
colorscheme mirodark              " sets the color
...
highlight CursorLine guibg=#000000 ctermbg=16
